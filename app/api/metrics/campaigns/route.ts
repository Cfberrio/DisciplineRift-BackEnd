...
// Datos de ejemplo para las métricas de campañas
...
// GET /api/metrics/campaigns - Obtener métricas de todas las campañas
export async function GET() {
  return NextResponse.json(campaignMetricsData)
}
