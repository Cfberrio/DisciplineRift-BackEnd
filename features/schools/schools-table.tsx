...
export function SchoolsTable() {
  ...
  return (
    <>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Administra las escuelas de tu organización</CardDescription>
            </div>
      ...
      <SchoolDialog open={showSchoolDialog} onClose={handleCloseDialog} initialData={selectedSchool} />

      <DeleteSchoolDialog open={showDeleteDialog} onClose={handleCloseDeleteDialog} school={selectedSchool} />
    </>
  )
}
